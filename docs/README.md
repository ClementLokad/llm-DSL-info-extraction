...
- **[Structural Engine (env_graph)](https://github.com/ClementLokad/llm-DSL-info-extraction/tree/main/env_graph/)**: Static analysis layer for building the dependency graph. Detailed usage: **[Graph Tool](tools/graph_tool.md)**.
