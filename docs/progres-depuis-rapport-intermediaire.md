...
## Axes de finalisation restants

Pour la livraison finale du PSC, la priorite doit desormais etre placee sur :

- narratif du rapport final et qualite des preuves ;
- tableaux de benchmark reproductibles et interpretation ;
- discussion explicite des limitations et perspectives ;
- coherence de la soutenance orale avec les livrables ecrits.
